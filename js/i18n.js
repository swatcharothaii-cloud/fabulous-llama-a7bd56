...
const DICT = {
  ...
  "rep.sendLine": ["📤 ส่งสรุปเข้า LINE", "📤 Send summary to LINE"],
  "rep.lineSummaryTitle": ["📤 ส่งสรุปเข้า LINE", "📤 Send summary to LINE"],
  "rep.lineDateFrom": ["วันที่ (จาก)", "Date (from)"],
  "rep.lineDateTo": ["วันที่ (ถึง)", "Date (to)"],
  "rep.lineType": ["ประเภทสรุป", "Summary type"],
  "rep.lineSummaryHint": [
    "เลือกช่วงวันที่ได้สูงสุด 31 วันต่อครั้ง (ถ้าเลือกวันเดียว จะได้สรุปแบบละเอียดของวันนั้น ถ้าเลือกหลายวัน จะได้สรุปแยกเป็นรายวัน)",
    "You can select up to 31 days at a time (a single day gives a detailed summary; multiple days give a per-day breakdown)",
  ],
  "rep.lineTypeAll": ["ภาพรวมทั้งบริษัท (ทุกแผนกรวมกัน)", "Company-wide overview (all departments combined)"],
  "rep.lineTypeByDept": ["แยกยอดตามแผนก", "Broken down by department"],
  ...
  "emp.viewDeleted": ["🗑️ รายชื่อที่ถูกลบ", "🗑️ Deleted list"],
